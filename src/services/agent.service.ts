...
handoff.instructions ? `Instruções: ${handoff.instructions}` : '',
  ...
  if (opts.knowledgeBase) {
    base.push(
      ...
      'O bloco "ESTRATÉGIA DE ABORDAGEM", o SALES PLAYBOOK e os dados do lead (nicho/negócio/categoria) são apenas auxiliares de PERSONALIZAÇÃO de tom e linguagem. Eles NUNCA definem o que a campanha vende nem podem contradizer a Base: quando a Base contém a informação, a Base prevalece. Não responda sobre o produto/serviço com base no nicho do lead ou em regras genéricas.',
      'SE a ESTRATÉGIA DE ABORDAGEM ou o SALES PLAYBOOK citar um negócio diferente do que a BASE define (ex.: sugerir abordagem para pastelaria, restaurante ou outro ramo), IGNORE essas instruções de negócio: o produto/serviço que VOCÊ vende é SEMPRE o descrito na BASE DE CONHECIMENTO. Use a estratégia apenas para o tom e o estilo da conversa, nunca para trocar o produto/serviço que você oferece.',
